document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupEventListeners() {
        ...
        btnNuevaVenta.addEventListener('click', function() {
            ...
            const modal = new bootstrap.Modal(document.getElementById('nuevaVentaAccesoriosModal'));
            modal.show();
        });
    ...
    function guardarVenta() {
        ...
        bootstrap.Modal.getInstance(document.getElementById('nuevaVentaAccesoriosModal')).hide();
        renderizarTabla(ventasAccesorios);
    }
